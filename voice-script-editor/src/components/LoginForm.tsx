      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="max-w-sm mx-auto">
          <form onSubmit={handleSubmit} className="space-y-6">
            {errors.general && (
              <div className="bg-red-50 dark:bg-red-900/50 border border-red-200 dark:border-red-500/50 text-red-800 dark:text-red-200 px-4 py-3 rounded-xl backdrop-blur-sm">
              ...
              {isSignupMode && (
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-4 bg-white dark:bg-slate-800/80 border-0 rounded-xl text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-all duration-200 ${

        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div 
              ...
              className="group bg-slate-800/50 backdrop-blur-sm border-2 border-dashed border-slate-600/50 rounded-2xl p-8 text-center hover:border-amber-500/50 transition-all duration-300 cursor-pointer"
            >
            ...
            {scripts.map((script) => (
              <div 
                ...
                className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 hover:border-slate-600/50 transition-all duration-300 cursor-pointer"
              >
                ...
                <h3 className="text-lg font-semibold text-white mb-2 truncate">{script.title}</h3>
            ...
            {scripts.length === 0 && (
              <div className="col-span-full text-center py-12">
                ...
                <p className="text-gray-400 mb-6">Start your screenwriting journey by creating your first script</p>
                <button
                  onClick={handleCreateScript}
